...
describe('Service Tests', () => {
    ...
    describe('UserExtra Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(UserExtraService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/user-extras/' + 123);
            });
            it('should return UserExtra', () => {

                let entity: UserExtra;
                service.find(123).subscribe((_entity: UserExtra) => {
                    entity = _entity;
                });
