...
describe('Service Tests', () => {
    ...
    describe('TimeEntry Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TimeEntryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/time-entries';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TimeEntry', () => {

                let entity: TimeEntry;
                service.find(123).subscribe((_entity: TimeEntry) => {
                    entity = _entity;
                });
