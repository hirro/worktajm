...
export class Header extends React.Component<IHeaderProps, { menuOpen: boolean }> {
  ...
  render() {
    ...
    const entityMenuItems = [
      (
        <DropdownItem tag={Link} key="address" to="/address">
          <FaAsterisk />&nbsp;
          Address
        </DropdownItem>
      ),
      (
        <DropdownItem tag={Link} key="project" to="/project">
          <FaAsterisk />&nbsp;
          Project
        </DropdownItem>
      ),
      (
        <DropdownItem tag={Link} key="customer" to="/customer">
          <FaAsterisk />&nbsp;
          Customer
        </DropdownItem>
      ),
      (
        <DropdownItem tag={Link} key="time-entry" to="/time-entry">
          <FaAsterisk />&nbsp;
          Time Entry
        </DropdownItem>
      ),
      (
        <DropdownItem tag={Link} key="domain" to="/domain">
          <FaAsterisk />&nbsp;
          Domain
        </DropdownItem>
      ),
      ...
      <div id="app-header">
        ...
        <Navbar dark expand="sm" fixed="top" className="jh-navbar">
          ...
          <NavbarBrand tag={Link} to="/" className="brand-logo">
            <BrandIcon />
            <span className="brand-title"><Translate contentKey="global.title">Worktajm</Translate></span>
