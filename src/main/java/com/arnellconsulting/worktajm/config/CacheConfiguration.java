...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.arnellconsulting.worktajm.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.arnellconsulting.worktajm.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(com.arnellconsulting.worktajm.domain.User.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.arnellconsulting.worktajm.domain.Project.class.getName() + ".projectMembers", jcacheConfiguration);
            ...
            cm.createCache(com.arnellconsulting.worktajm.domain.Domain.class.getName() + ".authorizedUsers", jcacheConfiguration);
            cm.createCache(com.arnellconsulting.worktajm.domain.UserExtra.class.getName(), jcacheConfiguration);
