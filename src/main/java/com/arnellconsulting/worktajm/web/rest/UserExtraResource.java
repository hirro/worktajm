...
public class UserExtraResource {
    ...
    public UserExtraResource(UserExtraRepository userExtraRepository, UserExtraMapper userExtraMapper, UserExtraSearchRepository userExtraSearchRepository) {
    ...
    public ResponseEntity<List<UserExtraDTO>> getAllUserExtras(Pageable pageable) {
        ...
        return new ResponseEntity<>(userExtraMapper.toDto(page.getContent()), headers, HttpStatus.OK);
    }
